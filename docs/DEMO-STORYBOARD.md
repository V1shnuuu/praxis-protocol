...
| **0:52–1:05** | Dispute resolves. Hold on the before/after block. | "Upheld — bond slashed". Before 10,000 PRAX → After 8,000 PRAX. Bond slashed 2,000. Paid to challenger 1,100. Reputation drops ~195 points, from the low 600s to the mid 400s. | "The challenge is upheld. Two thousand PRAX burned from the bond, eleven hundred paid to the challenger who caught it, and the reputation drops by nearly two hundred points — live." |
...
- **Don't script the exact reputation numbers.** The bond figures are fixed by
  ...
  the button, so it shifts by a few points between takes. The drop itself is
  steady at about 195: 150 for the slash, 40 for the share of lifetime bond
  burned, and 5 for the attestation that stops counting as clean.
